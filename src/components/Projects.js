    ...
    <section className="projects" id="projects">
        ...
        <div className="projects-container">
            <div className="project-box hidden">
                <img src="/assets/Screenshot 2026-04-26 130728.png" alt="Project 1" />
                <div className="project-layer">
                    <h4>Asher_services</h4>
                    <p>Modern and sleek portfolio design with smooth animations.</p>
                    <a href="https://asher-services.vercel.app/"><i className="fas fa-external-link-alt"></i></a>
                </div>
            </div>
            <div className="project-box hidden">
